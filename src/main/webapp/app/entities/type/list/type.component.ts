...
export class TypeComponent implements OnInit {
  ...
  constructor(protected typeService: TypeService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.types = [];
    ...
    this.typeService
      ...
      .subscribe(
        (res: HttpResponse<IType[]>) => {
          ...
          this.paginateTypes(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
  ...
  protected paginateTypes(data: IType[] | null, headers: HttpHeaders): void {
