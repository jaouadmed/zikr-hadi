...
describe('Component Tests', () => {
  describe('Zikr Management Component', () => {
    let comp: ZikrComponent;
    let fixture: ComponentFixture<ZikrComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ZikrComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ZikrComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.zikrs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
